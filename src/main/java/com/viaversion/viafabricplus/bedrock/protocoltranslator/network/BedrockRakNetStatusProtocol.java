...
public class BedrockRakNetStatusProtocol extends AbstractSimpleProtocol {

    public static final BedrockRakNetStatusProtocol INSTANCE = new BedrockRakNetStatusProtocol();
    ...
    private BedrockRakNetStatusProtocol() {
        this.initialize();
    }
    ...
    protected void registerPackets() {
        ...
        this.registerServerbound(State.STATUS, ServerboundStatusPackets.PING_REQUEST.getId(), -1, wrapper -> {
            ...
            pongResponse.send(BedrockRakNetStatusProtocol.class);
        });
    }
